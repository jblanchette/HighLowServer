...
GameManager.prototype.leaveAllGames = function (member) {
	var memberId = member.id;

	_.each(this.list, function (game) {
		_.remove(game.members, function (removeMember) {
			return removeMember.id === memberId;
		});
	});

	console.log("Left all games for user: ", member);
};
